...
require('lazy').setup({
  ...
  },
  {
    ...
    dependencies = {
      ...
      { 'mason-org/mason-lspconfig.nvim' }, -- https://github.com/nvim-lua/kickstart.nvim/pull/1663/files
    ...
    config = function()
      ...
      -- https://github.com/nvim-lua/kickstart.nvim/pull/1663/files
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      format_on_save = function(bufnr)
        -- Disable for Python, since not all projects use Black
        -- TODO: figure out a way to tag files to enable format-on-save
